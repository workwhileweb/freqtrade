...
Phần này sẽ nêu bật một số dự án từ các thành viên của cộng đồng.
!!! Lưu ý
    Các dự án dưới đây phần lớn không được nhóm freqtrade duy trì, do đó, bạn hãy thận trọng trước khi sử dụng chúng.- [Example freqtrade strategies](https://github.com/freqtrade/freqtrade-strategies/)
